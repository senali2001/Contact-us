...
if ($conn->connect_error) {
    ...
    $stmt = $conn->prepare("INSERT INTO contactus(full_name, email, massage) VALUES (?, ?, ?)");
...
try {
    ...
    //Recipients
    $mail->setFrom('dreamscapesprt@gmail.com', 'DREAM SCAPE');
    ...
    $mail->addAddress('dreamscapesprt@gmail.com');
    $mail->isHTML(true);                                        // Set email format to HTML
    $mail->Subject = 'Contact Us Form Submission Dream Scape Tour';
